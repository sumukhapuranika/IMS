 ...
 */
        ...
        <div class="container">
          ...
          <form class="" action="../includes/AddPaymentRecord-inc.php" method="post">
            ...
            <br> <br>
            <button type="submit" name="submit" style="margin-left: 325px;" class="btn btn-dark">Add Payment Record</button>
            <br> <br> <br>
            <button name="" class="btn btn-dark"><a href="ShowRecordBook.php"> Show Record Book </a></button>
