...
<div class="container">
  <h1>Manage Policy</h1>
  <button name="" class="btn btn-dark"><a href="AddNewPolicy.php"> Add New Policy </a></button>
  <button name="" class="btn btn-dark"><a href="UpdatePolicy.php"> Update Policy </a></button>
  <button name="" class="btn btn-dark"><a href="DeletePolicy.php"> Delete Policy </a></button>
</div>
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="../ManagePolicy/ManagePolicy.php">
              Manage Policy
            </a>
          </li>
          <li class="nav-item">
