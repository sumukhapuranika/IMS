...
<div class="container">
  <h1>Modify Plan</h1>
  <button name="" class="btn btn-light"><a href="AddNewPlan.php"> Add New Plan </a></button>
  <button name="" class="btn btn-light"><a href="../View/ViewPlan.php"> View/Edit Plan </a></button>
</div>
